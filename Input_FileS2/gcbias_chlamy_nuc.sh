...
GENOME=/fs/cbsufsrv5/data1/chlamy/fastq/reference/Creinhardtii_281_v5.0.fa
...
#
# Where is it?
CHROM_SIZES=/fs/cbsufsrv5/data1/chlamy/fastq/reference/Creinhardtii.v5.sizes.txt
...
# trickier.
BAMFOLDER=/fs/cbsufsrv5/data1/chlamy/fastq/bowtie2/bam_files/FilteredPaired/
...
RES_FOLDER=$HOME/Chlamy_scripts/GC_corr
